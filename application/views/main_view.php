...
// выводим уведомление об успехе операции и перезагружаем страничку
		...
		function reload(){location = 'index.php#subscribe'}; 
		setTimeout('reload()', 0);
		-->
		</script>";
    }
...
// Загрузка файла и вывод сообщения
    ...
    if ($ee2 != null) {
        ...
        // Переменные с формы
        $nameR = $_POST['uname'];
        $text = $_POST['describe_message'];

        // Параметры для подключения
        $db_host = "localhost";
        $db_user = "root"; // Логин БД
        $db_password = ""; // Пароль БД
        $db_table = "recepts"; // Имя Таблицы БД
        // Подключение к базе данных
        $db = mysqli_connect($db_host, $db_user, $db_password, "recepts") OR DIE("Не могу создать соединение ");
...
<section id="welcome" class="tm-section">
    ...
    <p>Приветствуем вас на нашем сайте. У нас вы сможете найти рецепты различных десертов, выпечки, а так же сладких (а
        может иногда и не сладких) напитков. Так же вы можете подписаться на рассылку, чтобы наши вкусные рецепты
        радовали вас каждый день!</p>
    <div class="row">
        <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12 push-lg-4 push-md-5">
            <p>Мы обычные люди, которые любят готовить простые, но вкусные и красивые блюда. И нам очень хочется
                делиться этим с вами! Надеемся, вам понравится!</p>
        </div>
...
<section id="bakerygallery" class="tm-section">
    ...
    <div class="tm-gallery-container tm-gallery-1">
        <div class="tm-img-container tm-img-container-1 textimage">
            <img src="img/03.jpg" alt="Image" class="img-fluid tm-img-tn">
            <!--            <a href="./recipe?id=1"><span>Рецепт 1</span></a>-->
            <a href="./recipe?1"><span>Рецепт 1</span></a>
        </div>
        <!--       // <php echo $_GET['rid'] ?></php>-->
        <div class="tm-img-container tm-img-container-1 textimage">
            <img src="img/04.jpg" alt="Image" class="img-fluid tm-img-tn">
            <a href="./recipe?2"><span>Рецепт 2</span></a>
        </div>
        <div class="tm-img-container tm-img-container-1 textimage">
    ...
    <div class="row">
        <div class="col-lg-6">
            <form enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                    <textarea id="describe_message" name="describe_message" class="form-control" rows="9"
                ...
                <input type="hidden" name="go1" value="5"/>
